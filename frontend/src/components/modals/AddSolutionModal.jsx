                        ...
                        <>
                            ...
                            <div className="px-7 py-6 overflow-y-auto custom-scrollbar">
                                    ...
                                    <div className="space-y-4 mb-6">
                                        ...
                                        {imageMethod === 'camera' ? (
                                            ...
                                            <div className="relative border-2 border-dashed border-white/[0.08] rounded-xl p-8 flex flex-col items-center justify-center bg-surface-2/30 hover:bg-surface-2/50 transition-all cursor-pointer min-h-[200px]">
                                                ...
                                                {solutionImage ? <img src={solutionImage} alt="Preview" className="max-h-[300px] object-contain rounded-lg shadow-lg mb-4" /> : <div className="text-center"><ImageIcon className="w-10 h-10 text-slate-600 mx-auto mb-3" /><h4 className="text-white font-semibold mb-1 text-[13px]">Upload your solution image</h4><p className="text-[11px] text-slate-500">Drag or click to choose a file</p></div>}
                                            </div>
                                        )}
                                    </div>
                                )}
                                ...
                                <form id="add-solution-form" onSubmit={handleAddSolution} className="space-y-5 flex flex-col">
                                    <div>
                                        <label className="block text-[10px] font-extrabold text-slate-500 uppercase tracking-[0.18em] mb-2.5">Solution Title (Optional)</label>
                                    ...
                                    <div>
                                        <label className="block text-[10px] font-extrabold text-slate-500 uppercase tracking-[0.18em] mb-2.5">Solution Content (Markdown) (Optional)</label>
                            ...
                            <div className="px-7 py-5 border-t border-white/[0.06] shrink-0 flex items-center justify-end bg-black/20">
                                <div className="flex gap-3">
                                    ...
                                    <button form="add-solution-form" type="submit" disabled={addingSolution || (!title.trim() && !content.trim() && !solutionImage)} className="bg-blue-600 text-white shadow-lg text-[13px] font-bold px-8 py-3 rounded-xl disabled:opacity-50 transition-all flex items-center gap-2">
