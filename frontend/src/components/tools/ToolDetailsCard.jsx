...
const ToolDetailsCard = ({ tool, onClose }) => {
    if (!tool) return null;
    ...
    return (
        <ModalPortal>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 modal-backdrop fade-in" onClick={onClose}>
                <div 
                    className="w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden flex flex-col bg-surface-2 border border-border animate-in zoom-in-95 duration-300"
                ...
                >
                    ...
                    {/* Body */}
                    <div className="px-7 py-8 space-y-6 overflow-y-auto max-h-[70vh] custom-scrollbar">
