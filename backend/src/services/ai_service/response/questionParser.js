 ...
 */
export const parseQuestionToRichText = async ({ content, type }) => {
    try {
        ...
        const messages = [
            {
                ...
                ====================
                STRICT REQUIREMENT: MULTIPLE QUESTIONS
                ====================
                ...
                Each question object MUST follow the standard Rich Text schema:
                ...
                2. Use LaTeX for ALL math. Formulas MUST be wrapped in \\( ... \\) for inline or \\[ ... \\] for blocks.
                ...
                {
                  "questions": [
                    { "root": { "children": [{ "type": "paragraph", "children": [{ "type": "text", "text": "2+2=?" }] }] } },
                    { "root": { "children": [{ "type": "paragraph", "children": [{ "type": "text", "text": "3+3=?" }] }] } }
                  ]
                }
                ...
                {
                  "questions": [
                    { "root": { "children": [{ "type": "paragraph", "children": [{ "type": "text", "text": "1) 2+2=? 2) 3+3=?" }] }] } }
                  ]
                }
                `
            }
        ...
        // Final fallback
        return [{ root: { children: [{ type: 'paragraph', children: [{ type: 'text', text: content }] }] } }];
